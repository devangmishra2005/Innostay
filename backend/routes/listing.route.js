...
import { addListing, deleteListing, findListing, getListing, getRecommendations, ratingListing, reviewListing, search, updateListing } from "../controllers/listing.controller.js"
...
listingRouter.post("/reviews/:id",isAuth,reviewListing)
listingRouter.get("/search",search)
listingRouter.get("/recommendations",getRecommendations)
