...
function ViewCard() {
  ...
  const reviews = Array.isArray(cardDetails.reviews)
    ? cardDetails.reviews
    : [];
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto  relative pb-10">
      <div
      ...
      <div className="flex flex-col justify-start gap-5 bg-gray-200 px-8 py-4 rounded-md max-w-7xl w-full mt-8">
        <h1 className="text-3xl text-red-500">Reviews</h1>
        <div className="flex flex-col gap-3">
          ...
          {reviews.map((review, index) => {
            ...
            const label =
              typeof review === "object" ? review?.sentiment : undefined;
            const confidence =
              typeof review === "object" ? review?.confidence : undefined;
            const suggestedRating =
              typeof review === "object" ? review?.rating : undefined;
            ...
            return (
              ...
              >
                <p className="text-lg text-gray-800">{reviewText}</p>
                {label && (
                  <div className="mt-2 text-sm text-gray-600 flex flex-wrap gap-4">
                    ...
                    {suggestedRating !== undefined && (
                      <span>Suggested Rating: {suggestedRating} / 5</span>
                    )}
                  </div>
                )}
              </div>
          ...
          >
            ...
            <div className="w-[90%] flex items-start justify-start flex-col gap-[10px]">
              ...
              <input
                ...
                id="city"
                className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px] text-[black]"
                requiredplaceholder="city,country "
